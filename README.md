...
- **序号标识** — 越早的内容序号越小，自适应列宽不浪费空间
- **逐条删除** — 每行右侧 X 按钮可单独删除历史条目
- **磨砂半透明面板** — `NSVisualEffectView` 原生模糊效果，圆角暗色风格，禁用水平滚动
...
│                                                 │
│  ┌────────────────────────────────────────┐     │
│  │  5 │ 17:40:12 │ Hello World       │ X  │     │
│  │  4 │ 17:39:58 │ https://...       │ X  │     │
│  │  3 │ 17:39:02 │ import Swift      │ X  │     │
│  │  2 │ 昨天 18:00 │ 上一行内容       │ X  │     │
│  │  1 │ 06-10 09:30 │ 最早的内容      │ X  │     │
│  └────────────────────────────────────────┘     │
│      磨砂半透明 · 右下弹出 · 480×470            │
└─────────────────────────────────────────────────┘
```
...
│   ├── ClipboardStore.swift         # 剪切板轮询、去重、持久化、删除
│   ├── HistoryViewController.swift  # 历史面板（序号/时间/预览/X 四列 NSTableView）
